...
class SalasModel
{
    ...
    public static function selectAtivaById($id) 
    { 
      $sql = "SELECT id,status FROM salas WHERE id='".$id."' AND status!='0' ORDER BY id ASC"; 
    ...
    public static function verificarStatus($id) 
    { 
      $sql = "SELECT id,status FROM salas WHERE id='".$id."' ORDER BY id ASC"; 
