...
<html lang="pt-br">
    ...
    <body>
      ...
      <table class="col l12 disciplinas_tabela">
        ...
        <tbody>
          <?php $i=1; foreach ($temas as $tema) {?>
          <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo strtoupper_utf8($tema->getDescricao()); ?></td>
            <td class="center">
            	<a href="/listquestoes?tema=<?php echo $tema->getId(); ?>" class="waves-effect waves-light btn-flat green white-text">
