      ...
      <table class="col l12 disciplinas_tabela">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="center">
              <a onclick="window.location='/temporeal?sala=<?php echo $sala->getId(); ?>'" class="waves-effect waves-light btn-flat green white-text">
                <i class="material-icons left">timeline</i>Visualizar em Tempo Real</a>
            </td>
          </tr>
          <?php $i++;} ?>
